...
// L'avantage d'un tableau par rapport à une variable, c'est que nous pouvons aliaser plusieurs emplacements
...
// Ou encore utilisé l'initialisation à la volée
...
// → Les différents fonctions liées aux tableaux : 
